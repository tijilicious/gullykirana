          ...
          <div className="hero__phone-mockup">
            <div className="phone__screen">
              <div className="phone__header">
                <span className="phone__logo"><img src="/logo.jpeg" alt="logo" style={{width:'16px',height:'16px',borderRadius:'4px',verticalAlign:'middle',marginRight:'4px'}} />GullyKirana</span>
